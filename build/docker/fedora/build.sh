...
# MyTraL Docker Fedora image builder.
#
# Creates a Docker image with MyTraL running on Fedora.
...
IMAGE_TAG="mytral-fedora:${VERSION}"
IMAGE_LATEST="mytral-fedora:latest"

echo "=== MyTraL Docker Fedora image builder ==="
...
rm -rf build/docker/fedora/build
...
echo ""
echo "  To run:   make distro-docker-fedora-run"
echo "  To list:  docker images | grep mytral-fedora"
echo "================================================================================"
