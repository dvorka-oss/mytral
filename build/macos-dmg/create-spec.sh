...
# Create PyInstaller spec file for the MyTraL macOS app bundle (MyTraL.app)
...
# MyTraL macOS App Bundle - PyInstaller Spec File
...
exe = EXE(
    ...
    target_arch=None,  # native arch of the build machine (arm64 on Apple Silicon runners)
...
app = BUNDLE(
    ...
    info_plist={
        ...
        'LSMinimumSystemVersion': '11.0',  # first macOS release with Apple Silicon support
    },
)
EOF
